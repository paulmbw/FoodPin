...
/**
 We're subclassing UITableViewDataSource to let this class know where we are getting the data from, and UITableViewDelegate to delegate responsibility of
 how we should redner each cell.
 */
