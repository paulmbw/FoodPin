...
class RestaurantTableViewController: UITableViewController {
    ...
    // MARK: - Navigation
    /**
     This method gets executed when a transition is about to happen, As we have defined the segue to be showRestaurantDetail (with the Show style animiation),
    ...
    /**
     This returns the number of sections. If this is more than 1, the list of restaurants will be duplicated.
     */
